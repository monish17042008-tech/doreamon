...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-sky-600 to-sky-700 text-white overflow-hidden pt-12 pb-8 border-t-4 border-sky-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-sky-500/60">
          {/* Brand Info */}
          ...
          {/* Quick Nav Links */}
          <div className="flex flex-wrap justify-center gap-6 text-sm font-semibold text-sky-100">
            <Link to="/" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Home
            </Link>
            <Link to="/characters" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Characters
            </Link>
            <Link to="/episodes" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Episodes
            </Link>
            <Link to="/movies" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Movies
            </Link>
            <Link to="/gallery" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Gallery
            </Link>
            <Link to="/game" onClick={() => sound.playClick()} className="hover:text-white transition-colors">
              Game
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="w-9 h-9 rounded-full bg-sky-500/80 hover:bg-white hover:text-red-600 flex items-center justify-center transition-colors shadow-sm"
            >
            ...
            <a
              ...
              className="w-9 h-9 rounded-full bg-sky-500/80 hover:bg-white hover:text-pink-600 flex items-center justify-center transition-colors shadow-sm"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="w-9 h-9 rounded-full bg-sky-500/80 hover:bg-white hover:text-slate-950 flex items-center justify-center transition-colors shadow-sm"
            >
            ...
            <button
              onClick={scrollToTop}
              title="Scroll to top"
              className="w-9 h-9 rounded-full bg-sky-800/60 hover:bg-amber-400 hover:text-slate-900 flex items-center justify-center transition-colors ml-2 shadow-sm"
            >
